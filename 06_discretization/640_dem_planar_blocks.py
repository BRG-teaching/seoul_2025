...
session = compas.json_load(
    pathlib.Path(__file__).parent.parent / "data" / "rv_pattern.json"
)
...
# from compas_rhino.objects import select_objects
...
# Session
polygons = compas.json_load(
    pathlib.Path(__file__).parent.parent / "data" / "2d_pattern_non_parallel.json"
)
...
if compute_interactions:
    ...
    for edge in model.graph.edges():
        ...
        modifier_pairs.append(
            [interface0, interface1, elements[edge[0]], elements[edge[1]]]
        )
