...
trimesh = Mesh.from_vertices_and_faces(DV, DF)
trimesh.unify_cycles()
...
pattern_inverse_height_thickness(trimesh, 0.1, 0.2)
idos = pattern_idos(trimesh)
blocks = pattern_blocks(trimesh, idos)
